...
@Component({
  selector: 'app-shiftmgmt',
  templateUrl: './shiftmgmt.component.html',
  styleUrls: ['./shiftmgmt.component.css'],
  encapsulation:ViewEncapsulation.None
})
export class ShiftmgmtComponent implements OnInit {
...
@Input() empshiftstatus5 = {shnn:'',shs:'',shn:''};
  ...
  ngOnInit(): void {
    ...
    setInterval(()=>{
    this.apiservice.empshift().subscribe(data =>{  
...
this.shiftN1 = data[5].sttime + ' : ' + data[5].ettime;
      ...
      this.apiservice.empshift().subscribe(data1 =>{  
        console.log(data1)
  ...
  for(var i=0;i<=6;i++){
    ...
    this.conshiftA1 = data[0].sttime + ' : ' + data[0].ettime;
    this.conshiftB1 = data[1].sttime + ' : ' + data[1].ettime;
    this.conshiftC1 = data[2].sttime + ' : ' + data[2].ettime;
    this.conshiftD1 = data[3].sttime + ' : ' + data[3].ettime;
    this.conshiftG1 = data[4].sttime + ' : ' + data[4].ettime;
    this.conshiftN1 = data[5].sttime + ' : ' + data[5].ettime;
        });
    
      },2000)
        
          this.apiservice.contshift().subscribe(condata =>{  
            console.log(condata)
            console.log( condata[0].ettime);
            console.log(condata[0].sttime);
     
            console.log('jjjjjjjjj',condata[1].shs);
          //   window.onload = function(){
  ...
  onNavigate(location: string){ this.router.navigate(['test']); }
  
  data(){
    console.log(this.time);
    alert(this.time)
  
   //  console.log(data1.hour +':' + data1.minute);
   //  console.log(data2.hour +':' + data1.minute)
     }
  shf1(){
    
    if(this.shf==='Employees' || this.shf ===undefined){
      this.section1= true;
      this.section2=false;
      this.section3=false;
    } else if(this.shf==='Contractual Workers'){
      this.section2=true;
      this.section1=false;
      this.section3=false;
    ...
    }else if(this.shf==='Vehicles'){
      this.section3=true;
      this.section1=false;
      this.section2=false;
    }
    console.log(this.shf)
  ...
  addtime() {
    ...
    this.apiservice.timerange(this.empshiftdetails0).subscribe((data: {}) => {
      console.log(data);
    })
  }
  addtime1() {
    ...
    this.apiservice.timerange(this.empshiftdetails1).subscribe((data: {}) => {
      console.log(data);
    })
  }
  ...
  addtime2() {
    ...
    this.apiservice.timerange(this.empshiftdetails2).subscribe((data: {}) => {
      console.log(data);
    })
  }
  addtime3() {
    ...
    this.apiservice.timerange(this.empshiftdetails3).subscribe((data: {}) => {
      console.log(data);
    })
  }
  addtime4() {
    ...
    this.apiservice.timerange(this.empshiftdetails4).subscribe((data: {}) => {
      console.log(data);
    })
  }
  addtime5() {
    ...
    this.apiservice.timerange(this.empshiftdetails5).subscribe((data: {}) => {
      console.log(data);
    })
  }
  addstatus(){
   ...
   this.empshiftstatus0.shn=this.value
    ...
    this.apiservice.status(this.empshiftstatus0).subscribe((data: {}) => {
      console.log(data);
  ...
  addstatus1(){
    ...
    this.apiservice.status(this.empshiftstatus1).subscribe((data1: {}) => {
      console.log(data1);
    })
  ...
  addstatus2(){
    ...
    this.apiservice.status(this.empshiftstatus2).subscribe((data2: {}) => {
      console.log(data2);
    })
  ...
  addstatus3(){
    ...
    this.apiservice.status(this.empshiftstatus3).subscribe((data2: {}) => {
      console.log(data2);
    })
  ...
  addstatus4(){
    ...
    this.apiservice.status(this.empshiftstatus4).subscribe((data2: {}) => {
      console.log(data2);
    })
  ...
  addstatus5(){
    ...
    this.apiservice.status(this.empshiftstatus5).subscribe((data2: {}) => {
      console.log(data2);
    })
