...
@Component({
  selector: 'app-shiftveh',
  templateUrl: './shiftveh.component.html',
  styleUrls: ['./shiftveh.component.css'],
  encapsulation:ViewEncapsulation.None
})
export class ShiftvehComponent implements OnInit {
...
@Input() empshiftstatus5 = {shnn:'',shs:'',shn:''};
  ...
  ngOnInit(): void {
    ...
    setInterval(()=>{
    this.apiservice.vehicleshift().subscribe(data =>{  
...
this.shiftN1 = data[5].sttime + ' : ' + data[5].ettime;
      ...
      this.apiservice.vehicleshift().subscribe(data1 =>{  
        console.log(data1)
  ...
  addtime() {
    ...
    this.apiservice.timerange2(this.empshiftdetails0).subscribe((data: {}) => {
      console.log(data);
  ...
  addtime1() {
    ...
    this.apiservice.timerange2(this.empshiftdetails1).subscribe((data: {}) => {
      console.log(data);
    })
  }
  ...
  addtime2() {
    ...
    this.apiservice.timerange2(this.empshiftdetails2).subscribe((data: {}) => {
      console.log(data);
    })
  }
  addtime3() {
    ...
    this.apiservice.timerange2(this.empshiftdetails3).subscribe((data: {}) => {
      console.log(data);
    })
  }
  addtime4() {
    ...
    this.apiservice.timerange2(this.empshiftdetails4).subscribe((data: {}) => {
      console.log(data);
    })
  }
  addtime5() {
    ...
    this.apiservice.timerange2(this.empshiftdetails5).subscribe((data: {}) => {
      console.log(data);
    })
  }
  addstatus(){
    ...
    this.apiservice.status2(this.empshiftstatus0).subscribe((data: {}) => {
      console.log(data);
    })
  ...
  addstatus1(){
    ...
    this.apiservice.status2(this.empshiftstatus1).subscribe((data1: {}) => {
      console.log(data1);
    })
  ...
  addstatus2(){
    ...
    this.apiservice.status2(this.empshiftstatus2).subscribe((data2: {}) => {
      console.log(data2);
    })
  ...
  addstatus3(){
    ...
    this.apiservice.status2(this.empshiftstatus3).subscribe((data2: {}) => {
      console.log(data2);
    })
  ...
  addstatus4(){
    ...
    this.apiservice.status2(this.empshiftstatus4).subscribe((data2: {}) => {
      console.log(data2);
    })
  ...
  addstatus5(){
    ...
    this.apiservice.status2(this.empshiftstatus5).subscribe((data2: {}) => {
      console.log(data2);
    })
